...
def get_examples_html(word, current_nid):
    """
    Collects information from other notes that have the given word and generates an HTML table
    """
    col = mw.col
...
def on_js_message(handled, message, context):
    ...
    try:
        ...
        return (True, None) # Return that it has been handled
