...
def parse_words(head_field):
	"""
	Splits the Head field by comma and returns a list of words
...
def get_examples_html(words, current_nid):
	"""
	Collects information from other notes containing any of the given word list and generates an HTML table
	words: list of str (the Head field split by comma)
	"""
	if not words:
